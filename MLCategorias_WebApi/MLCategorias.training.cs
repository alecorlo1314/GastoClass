...
using Microsoft.ML.Trainers;
    public partial class MLCategorias
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Descripcion",outputColumnName:@"Descripcion")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Descripcion"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.18944314F,L2Regularization=0.07357809F,LabelColumnName=@"Categoria",FeatureColumnName=@"Features"}))      
